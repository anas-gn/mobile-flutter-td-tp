...
Future<void> getProducts(String baseUrl) async {
  // Convertir l'URL en un objet Uri
  ...
  if (response.statusCode == 200) {
    // Convertir la réponse JSON en une liste d'objets Dart
    ...
    print('Erreur lors de la récupération des produits. Code: ${response.statusCode}');
  }
}
